	...
	return (0, l.useEffect)(() => {
		...
		children: [
			...
			i === "telecamere" ? /* @__PURE__ */ (0, b.jsxs)("section", {
				...
				c && (n.ingressi?.cancelli?.length > 0 || n.ingressi?.porte?.length > 0) && /* @__PURE__ */ (0, b.jsx)("div", {
					className: "fascia-ingressi",
